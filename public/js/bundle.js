...
})(
  {
    ...
    'mapLeflet.js': [
      function (require, module, exports) {
        ...
        var mapfunction = function mapfunction(locations) {
 ...
 */
          ...
          function (config) {
            return new Promise(function dispatchXhrRequest(resolve, reject) {
              ...
              request.open(
                ...
                (0, _buildURL.default)(fullPath, config.params, config.paramsSerializer),
                true
              );
              ...
              if (_index.default.isStandardBrowserEnv) {
                // Add xsrf header
                const xsrfValue =
                  (config.withCredentials || (0, _isURLSameOrigin.default)(fullPath)) &&
    ...
    'index.js': [
      function (require, module, exports) {
        ...
        var _mapLeflet = require('./mapLeflet');
        ...
        if (map) {
          ...
          (0, _mapLeflet.mapfunction)(locations);
        }
        if (loginForm)
